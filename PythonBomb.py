...
description = ""PythonBomb - Your Friendly Spammer Application

PythonBomb can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more .... is not intented for malicious uses.
"""
